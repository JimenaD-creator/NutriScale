...
class ejercicios_babies_sobre : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ejercicios_babies_sobre)
        var back = (findViewById<ImageButton>(R.id.ib_b11))
        ...
        visorweb.loadUrl("https://youtu.be/VaLxGl-oxF8")
