...
class ejercicios_kids_sobre : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ejercicios_kids_sobre)
        var back = (findViewById<ImageButton>(R.id.ib_b13))
        ...
        visorweb.loadUrl("https://youtu.be/joOy4_Jh3Qw")
